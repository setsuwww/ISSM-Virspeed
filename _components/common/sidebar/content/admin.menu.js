...
export const adminMenu = [
  ...
  },
  {
    ...
    items: [
      {
        label: "Divisions",
        href: "/admin/dashboard/users/divisions",
      },
      {
        label: "Employees",
        ...
        activePaths: [
          ...
          "/admin/dashboard/users/employees/work-hours",
        ],
      },
      {
        label: "Attendances",
        href: "/admin/dashboard/users/attendances",
      },
      {
        label: "Work Hours",
        href: "/admin/dashboard/users/work-hours",
      },
    ],
  },
  {
